...
# should have a signature of Callable[[AnyQuart, Template, dict], None]
...
# functions should have a signature of Callable[[AnyQuart], None]
request_started = _signals.signal("request-started")

#: Called after a response is fully finalised, connected functions
# should have a signature of Callable[[AnyQuart, Response], None]
request_finished = _signals.signal("request-finished")

#: Called as the request context is teared down, connected functions
# should have a signature of Callable[[AnyQuart, Exception], None]
request_tearing_down = _signals.signal("request-tearing-down")

#: Called if there is an exception in a background task, connected
# functions should have a signature of Callable[[AnyQuart, Exception], None]
...
# Callable[[AnyQuart, Exception], None]
...
#: Called after a response is fully finalised, connected functions
# should have a signature of Callable[[AnyQuart, Optional[Response]], None]
...
# have a signature of Callable[[AnyQuart], None]
...
# should have a signature of Callable[[AnyQuart, str, str], None]
